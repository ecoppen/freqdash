...
class TestUtils(unittest.TestCase):
    def test_attributes(self):
        ...
        assert binance.spot_api_url == "https://api.binance.com"
        assert binance.spot_trade_url == "https://www.binance.com/en/trade/BASE_QUOTE"
    ...
    def test_get_spot_prices_valid(self):
        ...
        assert spot_prices == [
            ...
            {"symbol": "LTCBTC", "price": Decimal("0.004054")},
        ]
        assert binance.weight == 10
